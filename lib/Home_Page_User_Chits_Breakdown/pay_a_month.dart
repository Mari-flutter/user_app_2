...
class PayMonthPage extends StatelessWidget {
          ...
          Column(
            children: chitList.map((chit) {
              return Padding(
                ...
                child: ChitCard_for_pay_month(chit: chit),
              );
            }).toList(),
          ),
        ],
...
class ChitCard_for_pay_month extends StatelessWidget {
  final Map<String, dynamic> chit;

  const ChitCard_for_pay_month({super.key, required this.chit});
