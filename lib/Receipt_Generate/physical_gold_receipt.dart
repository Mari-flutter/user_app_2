...
Future<void> PhysicalGoldReceiptPDF(
                  ...
                  children: [
                    pw.Container(
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          pw.Text(
                            "Physical Gold Delivery Confirmed",
                            style: pw.TextStyle(
                              font: boldFont,
                              fontSize: 13,
                              color: PdfColor.fromHex('#9F6E38'),
                    ...
                    pw.SizedBox(height: 6),
                    pw.Text(
                      "Your physical gold is ready for collection. Please visit our store with this receipt and a valid ID to collect your gold.",
                      style: pw.TextStyle(
                        color: PdfColor.fromHex('#808080'),
                        font: regularFont,
                        fontSize: 11,
