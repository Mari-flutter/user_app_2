...
class Chit_add_account extends StatefulWidget {
  const Chit_add_account({super.key, required this.withdrawalAmount});
  final double withdrawalAmount;


  @override
  State<Chit_add_account> createState() => _Chit_add_accountState();
}

class _Chit_add_accountState extends State<Chit_add_account> {
  ...
  void initState() {
    ...
    print('DEBUG: Amount received in Chit_add_account: ${widget.withdrawalAmount}');
  }
  ...
  Future<void> _instantTransfer(BuildContext context) async {
    ...
    const String apiUrl = "https://foxlchits.com/api/RazorPayWithdraw/chit-withdraw-request";
    ...
    final Map<String, dynamic> body = {
      ...
      "narration": "Chit Instant Withdrawal",
    };
  ...
  Future<void> _processingTransfer(BuildContext context) async {
    final Token = await SecureStorageService.getToken();
    const String apiUrl = "https://foxlchits.com/api/WithdrawAmount/chit-withdraw-request";
    final String accountHolderName = banknamecontroller.text.trim();
    final _email = await SecureStorageService.getMail();
    final _profileID = await SecureStorageService.getProfileId();
    ...
    final Map<String, dynamic> body = {
      ...
      "ifsc": ifsccontroller.text,
      "amount": widget.withdrawalAmount, // 🔑 Using passed amount
      "narration": "Chit Processing Withdrawal",
    };
