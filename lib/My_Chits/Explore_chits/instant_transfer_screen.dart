...
class instant_transfer extends StatefulWidget {
  ...
  @override
  State<instant_transfer> createState() => _instant_transferState();
}

class _instant_transferState extends State<instant_transfer> {
  @override
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => HomeLayout(initialTab: 0,)),
                        );
                      },
                      child: Image.asset(
